...
c:Customer;
req:string="http://localhost:37353/api/Customers";
depreq:string="http://localhost:37353/api/Departments";
...
register():Observable<any>
{
  ...
  return this.http.get<any>('http://localhost:7213/api/Customers')
